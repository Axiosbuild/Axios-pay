...
const envSchema = z.object({
  ...
  APPBUILD_LOGS_BUCKET: z.literal('appbuild-logs').default('appbuild-logs'),
  APPBUILD_LOGS_REGION: z.string().min(1).optional(),
  APPBUILD_LOGS_ENDPOINT: z.string().url().optional(),
  APPBUILD_LOGS_ACCESS_KEY_ID: z.string().min(1).optional(),
  APPBUILD_LOGS_SECRET_ACCESS_KEY: z.string().min(1).optional(),
...
const defaultedKeys = [
  ...
  'APPBUILD_LOGS_REGION',
  'APPBUILD_LOGS_ENDPOINT',
  'APPBUILD_LOGS_ACCESS_KEY_ID',
  'APPBUILD_LOGS_SECRET_ACCESS_KEY',
  'DOJAH_APP_ID',
  'DOJAH_SECRET_KEY',
